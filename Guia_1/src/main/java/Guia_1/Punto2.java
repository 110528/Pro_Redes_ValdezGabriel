...
public class Punto2 {
	...
	static ArrayList ejercicioA2() {
		...
		String Apellido1 = reader.lector();

		ps.println("Ingrese el segundo apellido");
		String Apellido2 = reader.lector();

		ps.println("Ingrese el tercer apellido");
		String Apellido3 = reader.lector();
