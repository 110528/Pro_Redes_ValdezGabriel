...
public class Punto1 {
	...
	static String ejercicioB() {
		...
		ps.println("Ingrese el primer ángulo: ");
		String dato = entradaDeDatos();
		int angulo1 = Integer.parseInt(dato);
		ps.println("Ingrese el segundo ángulo: ");
		String dato2 = entradaDeDatos();
		...
		return ("Ángulo faltante: " + angulo3 + "\n" + "Verificación: \n" + "Ángulo 1 = " + angulo1 + "\n"
				+ "Ángulo 2 = " + angulo2 + "\n" + "Ángulo 3 = " + angulo3 + "\n" + "Suma total = " + totalAngulos);
	}

	static String ejercicioC() {
		ps.println("ingrese el área del cuadrado: ");
		...
		return ("El perímetro del cuadrado es: " + perimetro + " metros");
	}
	...
	static String ejercicioF() {
		...
		ps.println("ingrese el precio del artículo: ");
