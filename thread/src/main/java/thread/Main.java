...
public class Main {
	...
	public static void main(String[] args) {
		...
		// esta clase heredaba de thread asique es un hilo y tiene actividades para
		// hacer.
		Caja_hilos caja1 = new Caja_hilos();
		caja1.start();

		Seguridad tareasDeGuardia = new Seguridad();
		Thread guardia1 = new Thread(tareasDeGuardia,"dada");
		guardia1.start();

		Thread empleado = new Thread(new Runnable() {
